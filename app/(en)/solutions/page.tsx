...
function SecHead({ label, title, subtitle, centered, light }: { label?: string; title: string; subtitle?: string; centered?: boolean; light?: boolean }) {
  return (
  ...
  return (
    <>
      ...
      <section style={{ background: "var(--se-blue-dark)", position: "relative", overflow: "hidden", padding: "96px 0", backgroundImage: "radial-gradient(circle at 1px 1px, rgba(34,167,168,0.12) 1px, transparent 0)", backgroundSize: "20px 20px" }}>
        <div className="se-container">
          <SecHead label="Industry Details" title="How We Support Each Industry" centered light />
          <IndustryAccordion />
        </div>
      </section>
    </>
