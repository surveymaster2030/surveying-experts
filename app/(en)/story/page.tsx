    ...
    <>
      ...
      <section style={{ background: "var(--se-blue-dark)", padding: "80px 0 64px", position: "relative", overflow: "hidden" }}>
        ...
        <div className="se-container" style={{ position: "relative" }}>
          ...
          <p style={{ fontFamily: "var(--font-sans)", color: "#D5E7EF", fontSize: 18, lineHeight: 1.65, maxWidth: 500, margin: 0 }}>
      ...
      <section style={{ position: "relative", overflow: "hidden", padding: "96px 0", backgroundImage: "linear-gradient(rgba(53,80,97,0.06) 1px,transparent 1px),linear-gradient(90deg,rgba(53,80,97,0.06) 1px,transparent 1px)", backgroundSize: "40px 40px" }}>
        <div className="se-container">
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "start" }} className="kit-2col">
            ...
            {/* CEO Quote card */}
            <div style={{ borderRadius: "var(--radius-xl)", padding: "32px 28px", position: "relative", overflow: "hidden", background: "var(--se-blue-dark)" }}>
              ...
              <div style={{ position: "relative" }}>
                <div style={{ width: 40, height: 40, borderRadius: "50%", background: "var(--se-teal)", display: "grid", placeItems: "center", marginBottom: 20 }}>
                  <Quote size={18} style={{ color: "#fff" }} />
                </div>
                <p style={{ fontFamily: "var(--font-sans)", fontSize: 15, lineHeight: 1.8, color: "#E3EEF3", margin: "0 0 24px", fontStyle: "italic" }}>
                ...
                <div style={{ borderTop: "1px solid rgba(255,255,255,0.12)", paddingTop: 16 }}>
                  ...
                  <div style={{ fontFamily: "var(--font-sans)", fontSize: 13, color: "#B4CEDF", marginTop: 2 }}>Chief Executive Officer, Surveying Experts</div>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Timeline */}
      <section style={{ background: "var(--se-blue-dark)", position: "relative", overflow: "hidden", padding: "96px 0", backgroundImage: "radial-gradient(circle at 1px 1px, rgba(34,167,168,0.12) 1px, transparent 0)", backgroundSize: "20px 20px" }}>
        <div className="se-container">
          <SecHead label="Our Journey" title="Key Milestones" centered light />
            ...
            <div style={{ display: "flex", gap: 0, minWidth: 860, position: "relative" }}>
              ...
              {timeline.map((t) => (
                <div key={t.year} style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", padding: "0 6px", position: "relative" }}>
                  <div style={{ width: 40, height: 40, borderRadius: "50%", border: "3px solid var(--accent)", color: "#fff", display: "grid", placeItems: "center", position: "relative", zIndex: 1, marginBottom: 12, flexShrink: 0 }}>
                    {t.icon}
                  </div>
                  ...
                  <div style={{ background: "rgba(255,255,255,0.07)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: "var(--radius-md)", padding: "14px 10px", boxShadow: "var(--shadow-sm)", textAlign: "center", width: "100%" }}>
                    <div style={{ fontFamily: "var(--font-sans)", fontWeight: 700, fontSize: 13, color: "#fff", marginBottom: 4, lineHeight: 1.3 }}>{t.title}</div>
                    <div style={{ fontFamily: "var(--font-sans)", fontSize: 12, lineHeight: 1.5, color: "#CCDFE9" }}>{t.text}</div>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="se-container" style={{ position: "relative" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }} className="kit-2col">
            <div>
              ...
              <p style={{ fontFamily: "var(--font-sans)", fontSize: 16, lineHeight: 1.8, color: "#D5E7EF", margin: "0 0 28px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              {statsVision.map((s) => (
                <div key={s.l} style={{ border: "1px solid rgba(255,255,255,0.1)", borderRadius: "var(--radius-lg)", padding: "20px 16px", textAlign: "center" }}>
                  <div style={{ fontFamily: "var(--font-sans)", fontWeight: 800, fontSize: 32, color: "var(--accent)", lineHeight: 1, letterSpacing: "-0.02em" }}>{s.v}</div>
                  <div style={{ fontFamily: "var(--font-sans)", fontSize: 13, color: "#C5DAE6", marginTop: 6 }}>{s.l}</div>
                </div>
              ))}
            </div>
          </div>
