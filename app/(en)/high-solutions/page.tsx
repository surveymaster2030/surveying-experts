...
function Eyebrow({ children, teal }: { children: React.ReactNode; teal?: boolean }) {
  return (
    <span style={{ display: "inline-block", fontFamily: "var(--font-sans)", fontSize: 12, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.18em", color: teal ? "var(--se-teal)" : "var(--accent)", background: teal ? "rgba(34,167,168,0.15)" : "rgba(246,186,59,0.12)", marginBottom: "1.25rem" }}>
      {children}
    </span>
  );
}
    ...
    <>
      ...
      <section style={{ background: "#0d1e2a", position: "relative", overflow: "hidden", padding: "80px 0" }}>
        <div className="se-container" style={{ position: "relative", textAlign: "center" }}>
          ...
          <p style={{ fontFamily: "var(--font-sans)", fontSize: "var(--text-md)", color: "#CCDFE9", marginBottom: "2rem" }}>Tell us about your project and our team will recommend the right high solution.</p>
          <div style={{ display: "flex", flexWrap: "wrap", gap: 14, justifyContent: "center" }}>
            <Link href="/contact"
              style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "13px 26px", color: "#fff", background: "var(--se-teal)", fontWeight: 700, fontSize: 16, borderRadius: "var(--radius-md)", textDecoration: "none" }}>
