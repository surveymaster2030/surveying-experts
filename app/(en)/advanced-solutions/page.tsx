    ...
    <>
                ...
                <div key={s.title} style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center" }}>
                  ...
                  <div style={{ position: "relative", marginBottom: 16 }}>
                    ...
                    <div style={{
                      ...
                      background: "var(--accent)", border: "2px solid var(--se-gray-50)",
      ...
      <section style={{ background: "#0d1e2a", position: "relative", overflow: "hidden", padding: "80px 0", backgroundImage: "linear-gradient(rgba(34,167,168,0.05) 1px,transparent 1px),linear-gradient(90deg,rgba(34,167,168,0.05) 1px,transparent 1px)", backgroundSize: "36px 36px" }}>
        <div className="se-container" style={{ position: "relative", textAlign: "center" }}>
          ...
          <p style={{ fontFamily: "var(--font-sans)", fontSize: "var(--text-md)", color: "rgba(255,255,255,0.65)", marginBottom: "2rem" }}>Tell us about your project and our team will recommend the right advanced solution.</p>
