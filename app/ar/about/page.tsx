...
function IconTile({ children, color = "teal" }: { children: React.ReactNode; color?: "teal" | "blue" }) {
  return (
    <div style={{ width: 44, height: 44, borderRadius: "var(--radius-md)", background: color === "teal" ? "var(--se-teal)" : "var(--se-blue)", color: "#fff", display: "grid", placeItems: "center", flexShrink: 0 }}>
      {children}
    </div>
  );
}
