...
const footerLinks = {
  "الشركة": [
    ...
    { label: "اتصل بنا والفروع", href: "/ar/contact" },
  ],
  "الحلول": [
    { label: "الحلول حسب القطاع",     href: "/ar/solutions" },
    { label: "الحلول المتقدمة",       href: "/ar/advanced-solutions" },
    { label: "أجهزة GNSS و RTK",     href: "/ar/solutions#gnss" },
    { label: "التيودوليت الإلكتروني", href: "/ar/solutions#total-station" },
    { label: "المسح ثلاثي الأبعاد",   href: "/ar/solutions#scanning" },
    { label: "المسح تحت الأرض",       href: "/ar/advanced-solutions#gpr" },
    { label: "المسح البحري",          href: "/ar/advanced-solutions#marine" },
    { label: "المسح بالطائرة المسيّرة", href: "/ar/advanced-solutions#drone" },
  ],
  "الدعم": [
    { label: "الصيانة والمعايرة",    href: "/ar/maintenance-calibration" },
    { label: "طلب استشارة",          href: "/ar/contact" },
    { label: "المتجر الإلكتروني",    href: "https://surveyingexperts-sa.com/collections/all", external: true },
    { label: "ملف الشركة",           href: "https://drive.google.com/file/d/1pw2rTyozJbSaSbt8_G28zD81Qzdag7_a/view", external: true },
  ],
};
      ...
      <div className="se-container" style={{ position: "relative", padding: "4rem 1.5rem 2.5rem" }}>
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", marginBottom: "1rem" }}>
              ...
              <span style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 19, color: "white", letterSpacing: "-0.01em" }}>
                خبراء <span style={{ color: "var(--se-yellow)" }}>المساحة</span>
              </span>
            </div>
        ...
        >
          <p style={{ fontSize: "var(--text-sm)", color: "rgba(255,255,255,0.35)", margin: 0 }}>
            © {new Date().getFullYear()} خبراء المساحة. جميع الحقوق محفوظة.
          </p>
          <p style={{ fontSize: "var(--text-sm)", color: "rgba(255,255,255,0.25)", margin: 0 }}>
            معدات مساحة احترافية ودعم ميداني متكامل | المملكة العربية السعودية
          </p>
        </div>
      </div>
    </footer>
